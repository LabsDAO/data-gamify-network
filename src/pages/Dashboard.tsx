...
import UserPointsDashboard from '@/components/dashboard/UserPointsDashboard';
    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <Tabs defaultValue="tasks" className="mb-8">
        <TabsList className="mb-4">
          <TabsTrigger value="tasks">Tasks & Contributions</TabsTrigger>
          <TabsTrigger value="points">Points & Uploads</TabsTrigger>
        </TabsList>
